...
fun SettingsRoute(navController: NavHostController) {
	...
	SettingsScreen(
		   ...
		   showDeveloper = state.showDeveloperOptions,
		   onToggleShowDeveloper = viewModel::setShowDeveloperOptions,
...
fun SettingsScreen(
	...
	var isDebugEnabled by rememberSaveable { mutableStateOf(showDeveloper) }
	// Keep local state in sync when underlying preference changes
	androidx.compose.runtime.LaunchedEffect(showDeveloper) {
		isDebugEnabled = showDeveloper
	}
