...
fun generateMockItems(): List<UiClothingItem> {
    return listOf(
        ...
        UiClothingItem(id = "t2", name = "ネイビーポロ", brand = "Lacoste", type = ItemType.TOP, categoryKey = "polo", sleeveLength = SleeveLength.SHORT, thickness = Thickness.NORMAL, color = Color(0xFF1A237E), icon = R.drawable.ic_clothing_top, maxWears = 2, fit = FitType.SLIM),
        UiClothingItem(id = "t3", name = "グレースウェット", brand = "GU", type = ItemType.TOP, categoryKey = "sweatshirt", sleeveLength = SleeveLength.LONG, thickness = Thickness.THICK, color = Color.Gray, icon = R.drawable.ic_clothing_top, maxWears = 3, fit = FitType.LOOSE),
        UiClothingItem(id = "t4", name = "白シャツ", brand = "Brooks Brothers", type = ItemType.TOP, categoryKey = "dress_shirt", sleeveLength = SleeveLength.LONG, thickness = Thickness.THIN, color = Color.White, icon = R.drawable.ic_clothing_top, maxWears = 1),
        ...
        UiClothingItem(id = "b2", name = "黒スラックス", brand = "Global Work", type = ItemType.BOTTOM, categoryKey = "slacks", sleeveLength = SleeveLength.LONG, thickness = Thickness.NORMAL, color = Color(0xFF212121), icon = R.drawable.ic_clothing_bottom, maxWears = 4, fit = FitType.SLIM),
        ...
        UiClothingItem(id = "o2", name = "ダウンコート", brand = "The North Face", type = ItemType.OUTER, categoryKey = "coat", sleeveLength = SleeveLength.LONG, thickness = Thickness.THICK, color = Color(0xFF424242), icon = R.drawable.ic_clothing_outer, maxWears = 6, cleaningType = CleaningType.DRY),
