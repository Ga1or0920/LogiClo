...
object SampleData {
    ...
    val closetItems: List<ClothingItem> = listOf(
        ...
        // --- 確認用: 快適温度レンジを明示したアイテム ---
        ClothingItem(
            id = "item-021",
            name = "真夏用ドライTシャツ（28-40℃）",
            category = ClothingCategory.T_SHIRT,
            type = ClothingType.TOP,
            sleeveLength = SleeveLength.SHORT,
            thickness = Thickness.THIN,
            comfortMinCelsius = 28.0,
            comfortMaxCelsius = 40.0,
            colorHex = "#00BFFF",
            colorGroup = ColorGroup.VIVID,
            pattern = Pattern.SOLID,
            maxWears = 1,
        ...
        ClothingItem(
            ...
            sleeveLength = SleeveLength.LONG,
            thickness = Thickness.THICK,
            comfortMinCelsius = -5.0,
            comfortMaxCelsius = 8.0,
            colorHex = "#1A237E",
            colorGroup = ColorGroup.NAVY_BLUE,
            pattern = Pattern.SOLID,
            maxWears = 5,
        ...
        ClothingItem(
            ...
            sleeveLength = SleeveLength.LONG,
            thickness = Thickness.THIN,
            comfortMinCelsius = 14.0,
            comfortMaxCelsius = 22.0,
            colorHex = "#FFFFFF",
            colorGroup = ColorGroup.MONOTONE,
            pattern = Pattern.SOLID,
            maxWears = 1,
        ...
        ClothingItem(
            id = "item-025",
            name = "冬用ウールスラックス（0-12℃）",
            category = ClothingCategory.SLACKS,
            type = ClothingType.BOTTOM,
            sleeveLength = SleeveLength.NONE,
            thickness = Thickness.THICK,
            comfortMinCelsius = 0.0,
            comfortMaxCelsius = 12.0,
            colorHex = "#2F2F2F",
            colorGroup = ColorGroup.MONOTONE,
            pattern = Pattern.SOLID,
            maxWears = 4,
